...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.factory<_i6.BaseErrorResponseMapper<Map<String, dynamic>>>(
        () => _i7.JsonObjectErrorResponseMapper());
    ...
    gh.factory<_i11.JsonArraySuccessResponseMapper<dynamic>>(
        () => _i11.JsonArraySuccessResponseMapper<dynamic>());
    gh.factory<_i12.JsonObjectSuccessResponseMapper<dynamic>>(
        () => _i12.JsonObjectSuccessResponseMapper<dynamic>());
    ...
    gh.factory<_i21.GetCurrentUserUseCase>(
        () => _i21.GetCurrentUserUseCase(gh<_i18.UserRepository>()));
    gh.factory<_i22.RefreshTokenDatasource>(() =>
        _i22.RefreshTokDatasourceImp(gh<_i23.UnAuthenticatedRestApiClient>()));
    gh.lazySingleton<_i24.RefreshTokenRepository>(
        () => _i24.RefreshTokenRepository(
    ...
    gh.lazySingleton<_i27.AuthenticatedRestApiClient>(
        () => _i27.AuthenticatedRestApiClient(
    ...
    gh.factory<_i34.ForgotPasswordUseCase>(
        () => _i34.ForgotPasswordUseCase(gh<_i31.AuthRepository>()));
    gh.factory<_i35.LogoutUseCase>(
        () => _i35.LogoutUseCase(gh<_i31.AuthRepository>()));
    gh.factory<_i36.SignInUseCase>(
        () => _i36.SignInUseCase(gh<_i31.AuthRepository>()));
    gh.factory<_i37.SignUpUseCase>(
        () => _i37.SignUpUseCase(gh<_i31.AuthRepository>()));
    gh.factory<_i38.CommonBloc>(
        () => _i38.CommonBloc(gh<_i35.LogoutUseCase>()));
    gh.factory<_i39.ForgotPassBloc>(
        () => _i39.ForgotPassBloc(gh<_i34.ForgotPasswordUseCase>()));
    gh.factory<_i40.SignInBloc>(
        () => _i40.SignInBloc(gh<_i36.SignInUseCase>()));
    gh.factory<_i41.SignUpBloc>(
        () => _i41.SignUpBloc(gh<_i42.SignUpUseCase>()));
    return this;
  }
}
